...
LIBFLATBUFFERSCPP_EXPORT bool GenerateTextFromTable(const Parser &parser,
                                         const void *table,
                                         const std::string &tablename,
                                         std::string *text);
LIBFLATBUFFERSCPP_EXPORT const char *GenerateText(const Parser &parser, const void *flatbuffer,
                                std::string *text);
LIBFLATBUFFERSCPP_EXPORT const char *GenerateTextFile(const Parser &parser,
                                    const std::string &path,
                                    const std::string &file_name);

LIBFLATBUFFERSCPP_EXPORT const char *GenTextFromTable(const Parser &parser, const void *table,
                                    const std::string &tablename,
                                    std::string *text);
LIBFLATBUFFERSCPP_EXPORT const char *GenText(const Parser &parser, const void *flatbuffer,
                           std::string *text);
LIBFLATBUFFERSCPP_EXPORT const char *GenTextFile(const Parser &parser, const std::string &path,
                               const std::string &file_name);
